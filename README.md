[![Star](https://gitee.com/Ai-Thinker-Open/ai-pi-pal-chat-v2/badge/star.svg)](https://gitee.com/Ai-Thinker-Open/ai-pi-pal-chat-v2)
[![Fork](https://gitee.com/Ai-Thinker-Open/ai-pi-pal-chat-v2/badge/fork.svg)](https://gitee.com/Ai-Thinker-Open/ai-pi-pal-chat-v2)
[![License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)

![alt text](doc/IMG/AiPi-PalChatV2_Title.png)

# 小安AI AiPi-PlaChatV2 
## 一、产品概述
**AiPi-PalChatV2** 是一款接入了 **小智AI** 或 火山殷勤 的高性能语音交互开发板，专为智能语音场景设计。基于安信可 Ai-M61-32S 模组主控，具备高集成度、高性能等特性，支持 离线语音唤醒 与 语音打断 功能，结合 2W/8Ω 扬声器与双供电模式（Type-C + 电池），通过安信可IOT小程序进行配网，智能体选择&配置，快速部署语音交互能力的硬件创新场景。
### 1. 核心功能亮点
- 离线语音交互
  - 支持离线语音唤醒，解放双手
  - 支持语音打断，提升交互自然度
...
### 1. 中文接口图
![alt text](doc/IMG/port_zh.png)

### 2. 英文接口图
![alt text](doc/IMG/port_en.png)

## 三 尺寸大小

![alt text](doc/IMG/size.png)

## 四、屏幕显示

| ![alt text](doc/IMG/lcd_init.png)| ![alt text](doc/IMG/lcd_sleep.png) | ![alt text](doc/IMG/lcd_lisening.png) |
| :---: | :---: | :---: | 
