...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_img_set_src(ui->screen_emoij_label, &_sleep_0_alpha_100x100);
    lv_img_set_pivot(ui->screen_emoij_label, 50,50);
    lv_img_set_angle(ui->screen_emoij_label, 0);
    lv_obj_set_pos(ui->screen_emoij_label, -10, 110);
    lv_obj_set_size(ui->screen_emoij_label, 100, 100);
    ...
    lv_img_set_src(ui->screen_wifi_label, &_wifi_connected_alpha_35x28);
    ...
    lv_obj_set_size(ui->screen_wifi_label, 35, 28);
    ...
    lv_label_set_text(ui->screen_font_label, "23吖6524132按时地方阿水电费2gas234df1as3df23adf");
    lv_label_set_long_mode(ui->screen_font_label, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_font_label, 74, 113);
