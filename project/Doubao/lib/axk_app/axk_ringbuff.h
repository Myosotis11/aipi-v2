#ifndef __AXK_AT_RING_BUFF_H__
#define __AXK_AT_RING_BUFF_H__
...
/**
  ...
  */
static inline unsigned int ring_buff_avail(ring_buff_t* ring_buff)
{
  return ring_buff->size - ring_buff_get_size(ring_buff);
}
