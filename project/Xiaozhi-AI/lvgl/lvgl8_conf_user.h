...
#ifndef CONFIG_LVGL8
#error "CONFIG_LVGL8 is not enabled"
#endif
...
#ifdef CONFIG_PSRAM
#define LV_ATTRIBUTE_FAST_MEM  //ATTR_PSRAM_CODE_SECTION
#else
...
#define LV_FONT_CUSTOM_DECLARE  LV_FONT_DECLARE(FishTankFont8) LV_FONT_DECLARE(wifi_status) LV_FONT_DECLARE(emoij)
