...
//#define MBEDTLS_ECP_DP_SECP192K1_ENABLED1
...
// #define MBEDTLS_ENTROPY_C      // 启用熵模块
// #define MBEDTLS_CTR_DRBG_C     // 或 MBEDTLS_HMAC_DRBG_C

#define MBEDTLS_THREADING_C
#define MBEDTLS_THREADING_PTHREAD // 或其他线程库
